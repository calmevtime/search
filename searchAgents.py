...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        self.corners = ((1, 1), (1, top), (right, 1), (right, top), ((1+right)/2, (1+top)/2))
    ...
    def getStartState(self):
        ...
        return (startState, self.corners)
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            nextx, nexty = map(int, (x+dx, y+dy))

            newCorner = []
            if not self.walls[nextx][nexty]:
                for item in state[1]:
                    if item != (nextx, nexty):
                        newCorner.append(item)
...
def cornersHeuristic(state, problem):
    ...
    if not state[1]:
        ...
        for item in state[1]:
            path_length.append(util.manhattanDistance(item, state[0]))
